 ...
 */
package net.changwoo.chat.atmosphere;
...
public final class AtmosphereUtils {
	...
	public static void suspend(final AtmosphereResource resource) {
		...
		LOG.info("--AtmosphereUtils.lookupBroadcaster().addAtmosphereResource(resource);");
//		if (AtmosphereResource.TRANSPORT.LONG_POLLING.equals(resource.transport())) {
			resource.resumeOnBroadcast(true).suspend(-1, false);
			LOG.info("--resource.resumeOnBroadcast(true).suspend(-1, false);");
//		} else {
//			resource.suspend(-1);
//			LOG.info("--resource.suspend(-1);");
//		}
